...
To perform *K-Means* clustering we use the function *kmeans()* (built-in with *stats* 
package).
...
We begin by clustering observations using complete linkage. The <span style="color:red"></span style="color:red">**dist()**</span> function is used to compute the 50 × 50 inter-observation Euclidean distance matrix.
